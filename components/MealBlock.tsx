...
export default function MealBlock({ meal }) {
    ...
    return (
        <a href={meal.link} className={cn("group w-full bg-gray-200 my-6 h-auto lg:h-72 flex flex-col rounded-lg overflow-hidden shadow-md duration-300 scale-100 hover:scale-105 lg:flex-row")}>
